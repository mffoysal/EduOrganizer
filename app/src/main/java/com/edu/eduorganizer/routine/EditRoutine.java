...
public class EditRoutine extends AppCompatActivity implements View.OnClickListener {
...
//                        Toast.makeText(getApplicationContext(),"Internet Connected",Toast.LENGTH_SHORT).show();
        ...
        timeFrom.setText(routine.getTemp_name());
        timeTo.setText(routine.getTemp_details());
...
//                        Log.e("UserFound","User FF Found");
    ...
    private void updateRoutine() {
        ...
        Routine routinee = new Routine();
        routinee = routine;
        routinee.setTemp_name(from_time);
        routinee.setTemp_details(to_time);

        RoutineD routineD = new RoutineD(database);
        long rs = routineD.updateRoutine(routinee);
        if(rs==-1){
            Toast.makeText(this,"Schedule Data Not inserted! Try again!  "+rs,Toast.LENGTH_SHORT).show();
    ...
    private void showTimePickerDialogTwo() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(EditRoutine.this, android.R.style.Theme_Holo_Dialog_MinWidth ,new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void showTimePickerDialog() {
        ...
        t1Hour = calendar.get(Calendar.HOUR_OF_DAY);
        t1Minute = calendar.get(Calendar.MINUTE);
        TimePickerDialog timePickerDialog = new TimePickerDialog(EditRoutine.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                t1Hour = hourOfDay;
                t1Minute = minute;
