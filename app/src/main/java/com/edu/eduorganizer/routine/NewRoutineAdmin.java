...
public class NewRoutineAdmin extends AppCompatActivity implements View.OnClickListener {
...
//                        Log.e("UserFound","User FF Found");
    ...
    private void showTimePickerDialogTwo() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(NewRoutineAdmin.this, android.R.style.Theme_Holo_Dialog_MinWidth ,new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void showTimePickerDialog() {
        ...
        t1Hour = calendar.get(Calendar.HOUR_OF_DAY);
        t1Minute = calendar.get(Calendar.MINUTE);
        TimePickerDialog timePickerDialog = new TimePickerDialog(NewRoutineAdmin.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                t1Hour = hourOfDay;
                t1Minute = minute;
