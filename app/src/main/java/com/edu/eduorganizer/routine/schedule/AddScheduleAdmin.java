...
public class AddScheduleAdmin extends AppCompatActivity implements View.OnClickListener {
...
//                        Log.e("UserFound","User FF Found");
    ...
    private void saveScheduleAndDuplicate() {
        ...
        scheduleItem.setSId(user.getSId());
        scheduleItem.setTemp_code(routine.getTemp_code());
        scheduleItem.setTemp_num(routine.getTemp_num());
    ...
    private void showTimePickerDialogTwo() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(AddScheduleAdmin.this, android.R.style.Theme_Holo_Dialog_MinWidth ,new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void showTimePickerDialog() {
        ...
        t1Hour = calendar.get(Calendar.HOUR_OF_DAY);
        t1Minute = calendar.get(Calendar.MINUTE);
        TimePickerDialog timePickerDialog = new TimePickerDialog(AddScheduleAdmin.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                t1Hour = hourOfDay;
                t1Minute = minute;
