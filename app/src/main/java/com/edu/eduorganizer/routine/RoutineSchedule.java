...
import com.edu.eduorganizer.routine.daily.weekly.FridayFragment;
import com.edu.eduorganizer.routine.daily.weekly.MondayFragment;
import com.edu.eduorganizer.routine.daily.weekly.SaturdayFragment;
import com.edu.eduorganizer.routine.daily.weekly.SundayFragment;
import com.edu.eduorganizer.routine.daily.weekly.ThursdayFragment;
import com.edu.eduorganizer.routine.daily.weekly.TuesdayFragment;
import com.edu.eduorganizer.routine.daily.weekly.WednesdayFragment;
        ...
        valueEventListener = studentRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot itemSnapshot: snapshot.getChildren()) {
                    ...
                    if (scheduleItem != null && scheduleItem.getSId().equals(sId) && scheduleItem.getTemp_code().equals(routine.getTemp_code()) || scheduleItem.getTemp_num().equals(routine.getTemp_num())) {
...
//                        Log.e("UserFound","User FF Found");
    ...
    private void showTimePickerDialogTwo() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(RoutineSchedule.this, android.R.style.Theme_Holo_Dialog_MinWidth ,new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void showTimePickerDialog() {
        ...
        t1Hour = calendar.get(Calendar.HOUR_OF_DAY);
        t1Minute = calendar.get(Calendar.MINUTE);
        TimePickerDialog timePickerDialog = new TimePickerDialog(RoutineSchedule.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                t1Hour = hourOfDay;
                t1Minute = minute;
    ...
    private void setupViewPager(ViewPager viewPager,Routine routine, List<ClassScheduleItem> dataList) {
        RoutineViewPagerAdapter adapter = new RoutineViewPagerAdapter(getSupportFragmentManager());
...
class RoutineViewPagerAdapter extends FragmentPagerAdapter {

    private final List<Fragment> fragmentList = new ArrayList<>();
    private final List<String> fragmentTitleList = new ArrayList<>();

    public RoutineViewPagerAdapter(FragmentManager manager) {
