...
public class ScheduleDuplicate extends AppCompatActivity implements View.OnClickListener {
    ...
    private ClassScheduleItem scheduleItem, classScheduleItem;
    private Routine routine;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_schedule_duplicate);
...
//            actionbar.setTitle(actionbar.getTitle()+" "+logout.getStringPreference("userId"));
        ...
        if (intent != null && intent.hasExtra("classSchedule")) {
            ...
            classScheduleItem = (ClassScheduleItem) intent.getSerializableExtra("classSchedule");
        }
...
//                        Log.e("UserFound","User FF Found");
    ...
    private void saveScheduleAndDuplicate() {
        ...
        scheduleItem.setSId(user.getSId());
        scheduleItem.setTemp_code(classScheduleItem.getTemp_code());
        scheduleItem.setTemp_num(classScheduleItem.getTemp_num());
    ...
    private void showTimePickerDialogTwo() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(ScheduleDuplicate.this, android.R.style.Theme_Holo_Dialog_MinWidth ,new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void showTimePickerDialog() {
        ...
        t1Hour = calendar.get(Calendar.HOUR_OF_DAY);
        t1Minute = calendar.get(Calendar.MINUTE);
        TimePickerDialog timePickerDialog = new TimePickerDialog(ScheduleDuplicate.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                t1Hour = hourOfDay;
                t1Minute = minute;
