...
public class ScanRoutine extends AppCompatActivity {
    ...
    private String selectedDay, routineTempCodeNum;
    ImageView recImage;
    ...
    private TextInputEditText routineCodeText;
    private MaterialButton downloadBtn, qrDownloadBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_routine);
...
//                        Toast.makeText(getApplicationContext(),"Internet Connected",Toast.LENGTH_SHORT).show();
        ...
        routineCodeText = findViewById(R.id.tempCodeNumId);
        downloadBtn = findViewById(R.id.btnRoutineDownload);
        qrDownloadBtn = findViewById(R.id.qrCodeScannerBtn);
        downloadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String tempCode = String.valueOf(routineCodeText.getText().toString().trim());
                if (tempCode.isEmpty()){
                    routineCodeText.setError("Please Provide a Routine Code");
                    routineCodeText.requestFocus();
                }else {
                    checkRoutine(tempCode);
                }

            }
        });
        qrDownloadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),RoutineScanner.class));
                finish();
            }
        });
