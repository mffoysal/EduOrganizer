package com.edu.eduorganizer.calendar;
...
public class CalendarD implements UserCallback {
    private static final String TABLE_NOTE = "calendar";
    ...
    public CalendarD(SQLiteDatabase database) {
        this.database = database;
    }

    public CalendarD(Context context) {
    ...
    public long insertCalendar(Calendar user) {
        long l=-2;
        int r=0;
        r = checkCalendarId(user.getUser_id(),user.getTask_code(),user.getTask_id(),user.getUniqueId());
        if(r!=0){
            return -3;
        }else {
            Log.e("Calendar","Calendar Insertion!");
        }
    ...
    public int checkCalendarId(String userId,String taskCode, String taskId, String uniqueId){
        int r = 0;
    ...
    public int checkCalendar(String taskName,String task_code, String task_id, String day){
        int r = 0;
    ...
    public int checkCalendar(String taskName,String task_code, String task_id, String day, String stdId){
        int r = 0;
    ...
    public Calendar getCalendar(String uniqueId){
    ...
    public List<Calendar> getAllCalendar() {
        List<Calendar> userList = new ArrayList<>();
    ...
    public List<Calendar> getAllCalendar(String userId, String taskCode) {
        List<Calendar> userList = new ArrayList<>();
...
//        Cursor cursor = database.query(TABLE_SCHEDULE, null, selection, selectionArgs, null, null, null);
    ...
    public int deleteAllCalendar(String uniqueId) {
    ...
    public int deleteAllCalendarWithTaskCode(String taskCode) {
    ...
    public int deleteAllCalendarWithTempCode(String taskId,String taskCode) {
        String whereClause = COLUMN_TASK_ID + " = ? OR task_code = ?";
    ...
    public List<Calendar> getAllCalendar(String day) {
        List<Calendar> userList = new ArrayList<>();
...
//        );
    ...
    public List<Calendar> getAllCalendar(String userId, String taskCode,String day) {
        List<Calendar> userList = new ArrayList<>();
//        Cursor cursor = database.rawQuery("SELECT * FROM " +TABLE_SCHEDULE + " WHERE uniqueId = ? OR stdId=? OR tId=? ",new String[]{uniqueId,uniqueId,uniqueId});
...
//        );
    ...
    public long updateCalendar(Calendar user) {
        ContentValues values = new ContentValues();
    ...
    public void saveCalendarInformation(String uniqueId, Calendar user) {
        // Save additional user information in Firestore or Realtime Database
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        CollectionReference usersCollection = db.collection("calendar");
...
//                    Toast.makeText(this, "Failed to save user information: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void saveCalendarInformationWithRealtime(String uniqueId,String studentId, String taskName,String taskCode, String taskId) {
        // Save additional user information in Firebase Realtime Database
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference usersRef = firebaseDatabase.getReference("calendar");
...
//                    Toast.makeText(this, "Failed to save user information: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void saveCalendarInformationWithRealtime(Calendar scheduleItem) {
        // Save additional user information in Firebase Realtime Database
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference usersRef = firebaseDatabase.getReference("calendar");
...
//                    Toast.makeText(this, "Failed to save user information: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void saveCalendarInformationWithRealtime(String uniqueId, Calendar u) {
        // Save additional user information in Firebase Realtime Database
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference usersRef = firebaseDatabase.getReference("calendar");
...
//                    Toast.makeText(this, "Failed to save user information: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public List<Calendar> getUnsyncedCalendarFromSQLite() {
        List<Calendar> unsyncedUsers = new ArrayList<>();
    ...
    public void checkAndSyncData() {
        List<Calendar> unsyncedUsers = getUnsyncedCalendarFromSQLite();
        for (Calendar user : unsyncedUsers) {
            // Add or update user data in Firebase
            addOrUpdateCalendarInFirebase(user);
        }
    }

    public void addOrUpdateCalendarInFirebase(Calendar user) {
        DatabaseReference usersRef = FirebaseDatabase.getInstance().getReference().child("calendar").child(String.valueOf(user.getId()));
...
//                    Toast.makeText(this, "Failed to sync user: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void updateCalendarData(Calendar user, School school) {
        DatabaseReference usersRef = FirebaseDatabase.getInstance().getReference("calendar");
    ...
    public Calendar getCalendarData(String userPhone) {
