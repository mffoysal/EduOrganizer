...
//    };
    ...
    public static ScheduleItem fromCursor(Cursor cursor) {
        ...
        int idColumnIndex = cursor.getColumnIndex(ScheduleCo.ScheduleEntry._ID);
        ...
        int subjectColumnIndex = cursor.getColumnIndex(ScheduleCo.ScheduleEntry.COLUMN_SUBJECT);
        if (subjectColumnIndex != -1) {
            scheduleItem.setSub_name(cursor.getString(subjectColumnIndex));
        }

        int dateTimeColumnIndex = cursor.getColumnIndex(ScheduleCo.ScheduleEntry.COLUMN_TIME);
