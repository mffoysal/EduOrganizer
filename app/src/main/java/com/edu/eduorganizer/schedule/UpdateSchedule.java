...
//                        Log.e("UserFound","User FF Found");
    ...
    public void updateSchedule(){
        ...
        ScheduleItem scheduleItemm = new ScheduleItem();
...
//        Toast.makeText(getApplicationContext(),""+scheduleItemm.getUniqueId(),Toast.LENGTH_SHORT).show();
    ...
    private void showTimePickerDialogTwo() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(UpdateSchedule.this, android.R.style.Theme_Holo_Dialog_MinWidth ,new TimePickerDialog.OnTimeSetListener() {
            @Override
