package com.edu.eduorganizer.task;
...
public class TaskD implements UserCallback {
    ...
    public TaskD(SQLiteDatabase database) {
        this.database = database;
    }

    public TaskD(Context context) {
    ...
    public long insertTask(com.edu.eduorganizer.entity.Task user) {
        long l=-2;
        int r=0;
        r = checkTaskId(user.getUser_id(),user.getTask_code(),user.getTask_id(),user.getUniqueId());
        if(r!=0){
            return -3;
        }else {
            Log.e("task","Task Insertion!");
        }
    ...
    public int checkTaskId(String userId,String taskCode, String taskId, String uniqueId){
        int r = 0;
    ...
    public int checkTask(String taskName,String task_code, String task_id, String day){
        int r = 0;
    ...
    public int checkTask(String taskName,String task_code, String task_id, String day, String stdId){
        int r = 0;
    ...
    public List<Task> getAllTask(String userId, String taskCode) {
        List<Task> userList = new ArrayList<>();
...
//        Cursor cursor = database.query(TABLE_SCHEDULE, null, selection, selectionArgs, null, null, null);
    ...
    public int deleteAllTask(String uniqueId) {
    ...
    public int deleteAllTaskWithTaskCode(String taskCode) {
    ...
    public int deleteAllTaskWithTempCode(String taskId,String taskCode) {
        String whereClause = COLUMN_TASK_ID + " = ? OR task_code = ?";
...
//        );
    ...
    public List<Task> getAllTask(String userId, String taskCode,String day) {
        List<Task> userList = new ArrayList<>();
//        Cursor cursor = database.rawQuery("SELECT * FROM " +TABLE_SCHEDULE + " WHERE uniqueId = ? OR stdId=? OR tId=? ",new String[]{uniqueId,uniqueId,uniqueId});
...
//        );
    ...
    public long updateTask(Task user) {
        ContentValues values = new ContentValues();
    ...
    public int deleteTask(String userId) {
        String whereClause = COLUMN_UNIQUE_ID + " = ?";
    ...
    public void saveTaskInformation(String uniqueId, Task user) {
        // Save additional user information in Firestore or Realtime Database
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        CollectionReference usersCollection = db.collection("task");
...
//                    Toast.makeText(this, "Failed to save user information: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void saveTaskInformationWithRealtime(String uniqueId,String studentId, String taskName,String taskCode, String taskId) {
        // Save additional user information in Firebase Realtime Database
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference usersRef = firebaseDatabase.getReference("task");
...
//                    Toast.makeText(this, "Failed to save user information: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void saveTaskInformationWithRealtime(Task scheduleItem) {
        // Save additional user information in Firebase Realtime Database
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference usersRef = firebaseDatabase.getReference("task");
...
//                    Toast.makeText(this, "Failed to save user information: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void saveTaskInformationWithRealtime(String uniqueId, Task u) {
        // Save additional user information in Firebase Realtime Database
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference usersRef = firebaseDatabase.getReference("task");
...
//                    Toast.makeText(this, "Failed to save user information: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public List<Task> getUnsyncedTaskFromSQLite() {
        List<Task> unsyncedUsers = new ArrayList<>();
    ...
    public void checkAndSyncData() {
        List<Task> unsyncedUsers = getUnsyncedTaskFromSQLite();
        for (Task user : unsyncedUsers) {
            // Add or update user data in Firebase
            addOrUpdateTaskInFirebase(user);
        }
    }

    public void addOrUpdateTaskInFirebase(Task user) {
        DatabaseReference usersRef = FirebaseDatabase.getInstance().getReference().child("task").child(String.valueOf(user.getId()));
...
//                    Toast.makeText(this, "Failed to sync user: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void updateTaskData(Task user, School school) {
        DatabaseReference usersRef = FirebaseDatabase.getInstance().getReference("task");
    ...
    public Task getTaskData(String userPhone) {
