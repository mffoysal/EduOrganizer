...
import com.edu.eduorganizer.routine.NewRoutineAdmin;
...
public class EduFragAdmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edu_admin, container, false);
        ...
        FloatingActionButton fabAdd = view.findViewById(R.id.fabRoutineAdd);
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), NewRoutineAdmin.class);
                startActivity(intent);
            }
        });
...
//        databaseManager.closeDatabase();
        ...
        viewPager.setAdapter(new EduFragAdmin.myPagerAdapter(getChildFragmentManager()));
